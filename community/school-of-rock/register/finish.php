...
$datb = mysql_connect("localhost", "edge_edge", "rAdio_993");
 ...
 $result = mysql_query("SELECT * FROM sor_applications WHERE id = '$paypal_id'") or die(mysql_error());  
...
function Header()
{
    ...
    $this->Cell(60);
    // Title
    $this->Cell(100,10,'SOR Paid Notice',1,0,'C');
    // Line break
    $this->Ln(40);
}
...
$pdf->Ln(20);
$pdf->SetFont('Arial','B',12);
$pdf->Cell(0,5,'REMINDER:',0,1);
$pdf->SetFont('Arial','',12);
$pdf->MultiCell(0,5,'Please contact this person with the full course dates, times and locations before the event.',0,1);

$pdfdoc = $pdf->Output("", "S");


$to = "webguy@edgeradio.org.au,schools@edgeradio.org.au,manager@edgeradio.org.au"; 
$from = "noreply@edgeradio.org.au"; 
$subject = "SOR Paid: ".$row['name'].""; 
...
<div id="main_fluid">
 ...
 <li style="color: #C0C0C0;">1. Contact Details</li>
...
<?php include '../../../inc/sidebar.php'; ?>
    ...
    <div id="two_column">
<div class="rounded">
<h1 class="title-head-right">Get Educated!</h1>
        <div style="padding: 20px 0 20px 0; font-size: 48px;" class="title">All Done!</div>
        <div style="padding: 20px 0 20px 0; font-size: 24px;" class="title">Thanks for submitting payment for the Edge Radio School of Rock course. We will send you more information shortly!</div>
