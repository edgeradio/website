...
var anarchy_url = 'http://www.edgeradio.org.au/player' // http address for the anarchy-media folder (no trailing slash).
var accepted_domains=new Array("edgeradio.org.au","edgeradio.com.au","edgeradio.net.au") 	// OPTIONAL - Restrict script use to your domains. Add root domain name (minus 'http' or 'www') in quotes, add extra domains in quotes and separated by comma.
...
Anarchy.Mp3 = {
	...
	toggle: function(img, url) {
		if (Anarchy.Mp3.playimg == img) Anarchy.Mp3.destroy()
			...
			'quality="high" wmode="transparent" width="270" height="22" name="player"' +
