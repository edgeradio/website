...
var nicYoutubeVideoOptions = {
	...
	iconFiles : {
		'youtubevideo' : 'http://dl.dropbox.com/u/4003320/nicedit/plugins/youtubevideo.png'
	}
};
/* END CONFIG */
...
var nicYoutubeVideoButton = nicEditorAdvancedButton.extend({	
	addPane : function() {
		this.addForm({
			...
			'url' : {type : 'text', txt : 'URL', value : 'http://', style : {width: '150px'}},
			'width' : {type : 'text', txt : 'Width', value : '470'},
			'height' : {type : 'text', txt : 'Height', value : '300'}
		},this.video);
	},
	...
	submit : function(e) {
		...
		if(url == "http://" || url == "") {
			alert("You must enter a valid video URL!");
			return false;
		}
