...
addItem('&nbsp; <strong>Listen Online</strong>', 'window.open("http://www.edgeradio.org.au/listen-popup.php", "ListenLive", "toolbar=0,scrollbars=0,location=0,statusbar=0,menubar=0,resizable=0,width=500,height=396")', 'js:', null, 87);
...
checkItem('&nbsp; Program Grid', 'http://www.edgeradio.org.au/program.php', '');
...
checkItem('&nbsp; <strong>Tasmanian Music Downloads</strong>', '/tasmanianmusic/', '');
...
checkItem('&nbsp; Adult Education Courses', 'http://www.edgeradio.org.au/training_ae.php', '');
...
checkItem('&nbsp; Featured Visual Artist', 'http://www.edgeradio.org.au/blog/', '');
...
checkItem('&nbsp; Jobs', 'http://www.edgeradio.org.au/jobs.php', '');
