     ...
     if(!empty($_POST['title']))
{
    ...
    if(isset($_POST['stream'])){
      ...
      $uid = $_POST['id'];
     	$registerquery = mysql_query("UPDATE program_special SET title='$title', summary='$summary', start_time='$start_time', end_time='$end_time', day_time='$day_time', streaming_enabled='$stream' WHERE id='$uid'");
        if($registerquery)
        {
        	echo "<h1>Success</h1>";
        	echo "
