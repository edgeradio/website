...
<h1 class="greyheader">Prizes Form</h1>
  <?php
...
$opts['fdd']['last'] = array(
  'name'     => 'Winners Last Name',
  'select'   => 'T',
  'maxlen'   => 20,
  'required' => false,
  'sort'     => true
);
$opts['fdd']['Suburb'] = array(
  'name'     => 'Winners Suburb',
  'select'   => 'T',
  'maxlen'   => 20,
  'required' => false,
...
$opts['fdd']['Presenter'] = array(
  'name'     => 'Presenters Full Name',
  'select'   => 'T',
  'maxlen'   => 30,
  'required' => false,
  'sort'     => true
...
$opts['fdd']['Display'] = array(
  'name'     => 'Display?',
  'select'   => 'T',
  'maxlen'   => 8,
  'required' => true,
  'sort'     => true,
  'values'   => array('Current','Recent', 'Archived')
);
