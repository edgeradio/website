   ...
   <!--  <link rel="image_src" href="<?php echo $infoprogprogprog['sml_img']; ?>" />
      ...
      <div style="padding: 10px; -moz-border-top-left-radius:15px; -webkit-border-top-left-radius:15px; -moz-border-top-right-radius:15px; -webkit-border-top-right-radius:15px; height: 180px; background-image: url(<?php if($infoprogprogprog['xl_img']) { echo $infoprogprogprog['xl_img']; } else { echo'http://www.edgeradio.org.au/images/edge-blank-page.png'; } ?>);">
       ...
       <?php } ?>
        ...
        <ul>
        <li><a href="http://www.edgeradio.org.au/program/<?php echo $gnid; ?>/playlists/">Program Home</a></li>
...
$pagination = " ";
	...
	<?=$pagination?>
		...
		?>
		<div style="background-color: #F0F0F0; -moz-border-bottom-left-radius:15px; -webkit-border-bottom-left-radius:15px; -moz-border-bottom-right-radius:15px; -webkit-border-bottom-right-radius:15px;">
		<div style="font-size: 40px; padding: 15px 10px 15px 10px;" class="title"><?php echo stripslashes($infoprogprogprog['title']); ?><br>
		<font style="font-size: 18px;"><?php echo $infoprogprogprog['day_time']; ?>  <?php echo $infoprogprogprog['start_time']; ?> - <?php echo $infoprogprogprog['end_time']; ?></font></div>
          </div>
          <br>
		<div class="rounded">
		...
		<div style="background-color: #F0F0F0; -moz-border-bottom-left-radius:15px; -webkit-border-bottom-left-radius:15px; -moz-border-bottom-right-radius:15px; -webkit-border-bottom-right-radius:15px;">
		<div style="font-size: 40px; padding: 15px 10px 15px 10px;" class="title"><?php echo stripslashes($infoprogprogprog['title']); ?><br><font style="font-size: 18px;">On Demand</font></div>
          </div>
          <br>
...
$FileFound=(checkRemoteFile($urlr));

//echo 'Show Day: '.$theday.'<BR>';
//echo 'Date Now: '.date("Y-m-d") . "<br>";
//echo 'Last Show Date: '.$day.'<BR>';
//echo 'Show Start Time: '.$time.'<BR>';
//echo 'MP3 File: http://mymyrecords.com/7edg/'.$day.' RESTREAM '.$time.'-00-00.mp3<BR>';
//echo 'Above file found: '.$FileFound.'<BR>';
