...
?>
<div class="rounded-side-new" onclick="javascript:popUpsoundcloud('http://www.edgeradio.org.au/soundcloud.php')" style="background-image: url(<?php echo $info['image_url']; ?>); cursor: pointer; height: 230px;">
