...
mysql_select_db("edge_music",$db);
   ...
   $myquery = "SELECT COUNT(*) as num FROM music WHERE tasmanian = 'true' public = 'true' ORDER BY date_added DESC";
...
$inforesult = mysql_query("SELECT * FROM music WHERE tasmanian = 'true' public = 'true' ORDER BY id DESC, date_added DESC LIMIT $start, $limit",$db);
$totalres = mysql_result(mysql_query("SELECT COUNT(*) as tot FROM music WHERE tasmanian = 'true' public = 'true' ORDER BY date_added DESC"),0);	
